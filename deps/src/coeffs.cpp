...
void singular_define_coeffs(jlcxx::Module & Singular)
{
    ...
    Singular.method("n_Init", [](long x, ip_sring * r) { return n_Init(x, r->cf); });
    Singular.method("n_Init", [](long x, coeffs n) { return n_Init(x, n); });

    Singular.method("n_Copy",
                    [](snumber * x, ip_sring * r) { return n_Copy(x, r->cf); });
    Singular.method("n_Copy",
    ...
    Singular.method("n_InitMPZ_internal", [](void * ptr, ip_sring * r) {
        return n_InitMPZ(reinterpret_cast<__mpz_struct *>(ptr), r->cf);
    });
    Singular.method("n_InitMPZ_internal", [](void * ptr, coeffs x) {
        return n_InitMPZ(reinterpret_cast<__mpz_struct *>(ptr), x);
    });

    Singular.method("n_Delete", [](snumber * n, ip_sring * r) {
        number * t = &n;
        if (n != NULL) {
            n_Delete(t, r->cf);
        }
    ...
    Singular.method("n_Write",
                    [](snumber * x, ip_sring * r) {
                        return n_Write(x, r->cf, 0);
                    });
    ...
    Singular.method("n_Add", [](snumber * a, snumber * b, ip_sring * r) {
        return n_Add(a, b, r->cf);
    });
    Singular.method("n_Add", [](snumber * a, snumber * b, coeffs c) {
        return n_Add(a, b, c);
    });

    Singular.method("n_Sub", [](snumber * a, snumber * b, ip_sring * r) {
        return n_Sub(a, b, r->cf);
    });
    Singular.method("n_Sub", [](snumber * a, snumber * b, coeffs c) {
        return n_Sub(a, b, c);
    });

    Singular.method("n_Mult", [](snumber * a, snumber * b, ip_sring * r) {
        return n_Mult(a, b, r->cf);
    });
    Singular.method("n_Mult", [](snumber * a, snumber * b, coeffs c) {
        return n_Mult(a, b, c);
    });

    Singular.method("n_Neg", [](snumber * a, coeffs c, ip_sring * r) {
        number nn = n_Copy(a, r->cf);
        nn = n_InpNeg(nn, r->cf);
        return nn;
    });
    ...
    Singular.method("n_Invers",
                    [](snumber * a, ip_sring * r) { return n_Invers(a, r->cf); });
    Singular.method("n_Invers",
    ...
    Singular.method("n_Div", [](snumber * a, snumber * b, ip_sring * r) {
        number z = n_Div(a, b, r->cf);
        n_Normalize(z, r->cf);
        return z;
    });
    ...
    Singular.method("n_Power", [](snumber * a, int b, ip_sring * r) {
        number res;
        n_Power(a, b, &res, r->cf);
        return res;
    });
    ...
    Singular.method("n_IsZero", [](snumber * x, ip_sring * r) {
        return n_IsZero(x, r->cf) > 0;
    });
